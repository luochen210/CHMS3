...
namespace BLL
{
    public class BLLHolidays : DataAccessBase
    {
        ...
        public IList<Model.Holidays> GetHolidaysIList(string strWhere)
        {
            ...
            return DbHelperSQL.GetIList<Model.Holidays>(sb.ToString(), CommandType.Text);
        }
